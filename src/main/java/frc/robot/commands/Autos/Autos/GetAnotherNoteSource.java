...
public class GetAnotherNoteSource extends SequentialCommandGroup {
        /** Creates a new GetAnotherNote. */
        public GetAnotherNoteSource(SwerveSubsystem swerve, TransferSubsystem transfer, IntakeSubsystem intake,
                        CommandFactory cf,
                        PathFactory pf) {
                ...
                addCommands(
                                Commands.sequence(
                                                ...
                                                cf.autopathfind(AllianceUtil.getSourceClearStagePose(),
                                                                SwerveConstants.pfConstraints, 0, 0),
                                                new RunPPath(swerve,
                                                                pf.pathMaps.get(sourcepaths.StageClearToSourceShoot
                                                                                .name())),
                                                Commands.parallel(
